...
function Itinerary(){
   ...
   const downloadPdf = () => {
    ...
    return(
        ...
        {/* Number of passengers for Flight */}
          ...
          <div className="form-group">
            ...
            <table className="table">
                ...
                <tbody id="activity_table">
                    ...
                    <tr key={index}>
                        ...
                        <td>{row.desc}</td>
                        <td>${row.cost}</td>
                        <td><button onClick={() => handleDeleteActivity(index)}>Delete</button></td>
                    </tr>
                ))}
                </tbody>
            </table>
            ...
            <div className="col-md-9"></div>
             <div className="text-left col-md-3">
                <button className="btn btn-primary" onClick={downloadPdf} type="submit" id="create_plan"> Create Plan</button>
            </div>
            </div>
        </div>
    </div>
